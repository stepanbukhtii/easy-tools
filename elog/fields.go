...
const (
	...
	KafkaTopicName      = "kafka.topic.name"
	KafkaTopicOffset    = "kafka.topic.offset"
	KafkaTopicPartition = "kafka.topic.partition"
	KafkaMessageKey     = "kafka.message.key"

	RabbitMQQueueName   = "rabbitmq.queue.name"
	RabbitMQConsumerTag = "rabbitmq.consumer.tag"
)
